      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="text-center md:text-left">
            <h3 className="font-lato text-2xl text-white mb-6"><span className="font-montserrat">SHONCI HEIDELBERG</span></h3>
            <h3 className="font-lato text-xl text-charcoal mb-2"><span className="font-montserrat">SHONCI HEIDELBERG</span></h3>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="text-cream/60 font-lato text-xs mt-6">&copy; {new Date().getFullYear()} <span className="font-montserrat">SHONCI HEIDELBERG</span>.<br />All rights reserved.</div>
          </div>
        </div>
      </div>
